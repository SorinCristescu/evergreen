# ba92d6da-ea15-456d-b6b7-efbe8935193a implementation handoff

This archive is the source of truth for turning the design into production code. Start from `evergreen-about.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `evergreen-about.html`
...
- A single self-contained `evergreen-about.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `evergreen-about.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `evergreen-about.html`
- `evergreen-account.html`
- `evergreen-acknowledgements.html`
- `evergreen-blocked.html`
- `evergreen-capture-identify.html`
- `evergreen-community.html`
- `evergreen-garden.html`
- `evergreen-identification-history.html`
- `evergreen-index.html`
- `evergreen-login.html`
- `evergreen-memorial.html`
- `evergreen-messages.html`
- `evergreen-notifications.html`
- `evergreen-onboarding-climate.html`
- `evergreen-onboarding-first-plant.html`
- `evergreen-onboarding-goals.html`
- `evergreen-onboarding-identify.html`
- `evergreen-onboarding-level.html`
- `evergreen-onboarding-name.html`
- `evergreen-onboarding-place-space.html`
- `evergreen-permissions.html`
- `evergreen-plant-detail.html`
- `evergreen-privacy.html`
- `evergreen-profile.html`
- `evergreen-rate.html`
- `evergreen-report.html`
- `evergreen-splash.html`
- `evergreen-terms.html`
- `evergreen-today.html`
- `evergreen-welcome.html`
- `evergreen-wishlist.html`
...
- `mq5zv7fm-components.md`
- `mq5zvbmz-screen-flow.md`
- `mq5zvipa-evergreen-diagram.pdf`
- `mq5zvt8u-prd.md`

## Coding checklist for AI tools
1. Inspect `evergreen-about.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
